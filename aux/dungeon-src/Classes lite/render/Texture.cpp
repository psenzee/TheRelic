...
Texture::Texture(ContentCache *content, const char *filename, const char *blendsrc, const char *blenddst)
    : filename(filename), texture(content->GetTexture(filename))
{
...
Texture::Texture(ContentCache *content, const char *filename, unsigned int blendsrc, unsigned int blenddst) 
    : filename(filename), texture(content->GetTexture(filename)), blendsrc(blendsrc), blenddst(blenddst)
{
}
