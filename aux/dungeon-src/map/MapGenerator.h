...
public:
    ...
    Map          *GenerateMap(int level, const core::Size &mapsz, XmlElement *levelConfig, const char *mapTypeName, int seed, int spiralLevel);
...
private:    
    ...
    void          SetPatternedFloor(ITileMap *map, int id, const core::Rectangle &area, ITileMap *pattern);
