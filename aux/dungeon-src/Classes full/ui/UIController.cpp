...
//  screens[ABANDON_PROGRESS]   = new Menu      ("\\#6600ffAbandon Progress?", 30);
    screens[ENTER_HIGH_SCORE]   = new Menu      ("\\#6600ff`New High Score!",   30);    
    ...
    Add(screens[MAIN_MENU],         context, "\\#6600ff`Play!",              MenuItem_Play);
    Add(screens[MAIN_MENU],         context, "\\#8080ff`Run the Gauntlet!",  MenuItem_MazesOnly);
//    Add(screens[MAIN_MENU],         context, " ",                            0);    
    Add(screens[MAIN_MENU],         context, "\\#c0c0c0New/Load Game",                MenuItem_NewLoadGame);
//  Add(screens[MAIN_MENU],         context, "High Scores",                  MenuItem_HighScores);
