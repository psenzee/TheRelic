...
function CreateSkeleton_Character(c, type, hp, speed, x, y)
   FillAttributeTable(c, math.random(hp / 2, hp), math.random() * speed, { ReceiveHitFn = SkeletonReceiveHit, DieFn = SkeletonDie})
