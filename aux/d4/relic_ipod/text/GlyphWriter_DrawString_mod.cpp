...
void GlyphWriter::DrawString(RenderContext &context, const char *s, const Vector2 &lookAt, const Vector2 &at, float alpha, float size, const Matrix &view)
{
    ...
    m = ms * m;
    DrawString(context, s, Vector2(-0.5f, 0.0f), Vector2(-0.5f, 0.0f), Vector4(1.0f, 1.0f, 1.0f, alpha), m, view, buffer);
}
...
void GlyphWriter::DrawString(RenderContext &context, const char *s, const Vector2 &start, const Vector2 &pos, const Vector4 &color, const Matrix &transform, const Matrix &view, void *buffer)
{
