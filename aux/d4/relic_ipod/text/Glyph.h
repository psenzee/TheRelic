...
public:
    ...
    void               DrawString(RenderContext &context, const char *s, const Vector2 &lookAt, const Vector2 &at, float alpha, float scaler, const Matrix &view);
...
private:
    ...
    void               DrawString(RenderContext &context, const char *s, const Vector2 &start, const Vector2 &pos, const Vector4 &color, const Matrix &transform, const Matrix &view, void *buffer);
