...
//    };
  ...
  //  inline Plane() : a(0.f), b(0.f), c(0.f), d(0.f)                    {} // force invalid..
...
//        return (normal != p.normal || !math::eq(dist, p.dist));
    ...
    inline float distance(const point_t &p) const // is this distance squared?
    {
        return dot(p) + dist;
    }
    ...
    */
    ...
    void set(const point_t &a, const point_t &b, const point_t &c);
