...
function AddTextLine(parent, text, height, size)
  AddTextLineLink(parent, text, height, size, '')
end

function AddTextLineLink(parent, text, height, size, event)
  AddTextLineLinkBorder(parent, text, height, size, event, '')
end
...
function CreateMainMenu()
  ...
  AddMenuButton(MAIN_MENU, "MainMenu_LoadGame", "Continue Saved Game", width)
...
--AddMenuButton(EXTRAS_MENU, "OtherGames",   "Other Games", width)
  ...
  AddMenuButton(EXTRAS_MENU, "MainMenu", "\\#808080Main Menu", width)
...
function CreateCharacterTip()
  CHARACTER_TIP = CreateTipByName("CharacterTip", "Tap your warrior to show the map.")
end
...
function CreateCredits()
  ...
  AddTextLine(CREDITS_SCREEN, "\\#808080created by", height, size)
...
function CreateConnectFailed()
  ...
  local size = 23
  local dividerHeight = 15
  CONNECTFAILED_SCREEN = Ui_CreateMenu("ConnectFailedControl", "", "..", 240 - halfWidth, MENUS_TOP - 50, 240 + halfWidth, MENUS_TOP + height, 1.0, 22.5)
...
function CreateInGameMapPage()
  ...
  local title = Ui_CreateText("Map", "Map", 20, TITLE_START, 80, TITLE_START + 50, 1.0, 30.0, false) 
