...
function CreateGeneratorGhost(type, hp, speed, x, y)
   local c = NewCharacter(-1, "GeneratorGhost", type, x, y, 0.0)
   CreateGeneratorGhost_Character(c, type, hp, speed, x, y)
end