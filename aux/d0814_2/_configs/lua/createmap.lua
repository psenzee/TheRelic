...
ENEMIES_MAX                      = 300
LOOT_MAX                         = 20
TILE_ENEMY_SPAWN_COUNT           = 5
TILE_ENEMY_SPAWN_DIFFICULT_COUNT = 3

function SpawnEnemiesAndLootAtTile(x, y, difficult)
  if x and y then
    print("SpawnEnemies")
    local count = TILE_ENEMY_SPAWN_COUNT
    if difficult then count = TILE_ENEMY_SPAWN_DIFFICULT_COUNT end
    for i = 1, count do
...
function CreateBarrelAndSerialize(x, y)
  local barrel = CreateBarrel("Barrel", 25.0, 0.0, x, y)
...
function CreateBarrelsWestCrateWallAtTile(x, y)
  if x and y then
    ...
    x = x * 256
    y = y * 256
    if BarrelLikelihood() then CreateBarrelAndSerialize(x - 48.0, y - 80.0) end
    if BarrelLikelihood() then CreateBarrelAndSerialize(x - 80.0, y - 20.0) end
    if BarrelLikelihood() then CreateBarrelAndSerialize(x - 54.0, y + 60.0) end
  end
end
...
function CreateBarrelsEastWallAtTile(x, y)
  if x and y then
    ...
    x = x * 256
    y = y * 256  
    if BarrelLikelihood() then CreateBarrelAndSerialize(x + 42.0, y - 30.0) end
    if BarrelLikelihood() then CreateBarrelAndSerialize(x + 48.0, y -  0.0) end
    if BarrelLikelihood() then CreateBarrelAndSerialize(x + 44.0, y + 24.0) end
  end
end
...
function CreateBarrelsNorthWallAtTile(x, y)
  if x and y then
    ...
    x = x * 256
    y = y * 256  
    if BarrelLikelihood() then CreateBarrelAndSerialize(x - 30.0, y - 42.0) end
    if BarrelLikelihood() then CreateBarrelAndSerialize(x -  0.0, y - 48.0) end
    if BarrelLikelihood() then CreateBarrelAndSerialize(x + 24.0, y - 44.0) end
  end
end
...
function PlaceBarrelsWestCrateWall()
    ...
    for i = 0, count - 1 do
      ...
      if BarrelLikelihood() then CreateBarrel("Barrel", 25.0, 0.0, x - 48.0, y - 80.0) end
      if BarrelLikelihood() then CreateBarrel("Barrel", 25.0, 0.0, x - 80.0, y - 20.0) end
      if BarrelLikelihood() then CreateBarrel("Barrel", 25.0, 0.0, x - 54.0, y + 60.0) end
    end
end
...
function PlaceBarrelsWestWall()
    ...
    for i = 0, count - 1 do
      ...
      if BarrelLikelihood() then CreateBarrel("Barrel", 25.0, 0.0, x - 48.0, y - 30.0) end
      if BarrelLikelihood() then CreateBarrel("Barrel", 25.0, 0.0, x - 40.0, y -  0.0) end
      if BarrelLikelihood() then CreateBarrel("Barrel", 25.0, 0.0, x - 54.0, y + 24.0) end
    end
end
...
function PlaceBarrelsEastWall()
    ...
    for i = 0, count - 1 do
      ...
      if BarrelLikelihood() then CreateBarrel("Barrel", 25.0, 0.0, x + 42.0, y - 30.0) end
      if BarrelLikelihood() then CreateBarrel("Barrel", 25.0, 0.0, x + 48.0, y -  0.0) end
      if BarrelLikelihood() then CreateBarrel("Barrel", 25.0, 0.0, x + 44.0, y + 24.0) end
    end
end
...
function PlaceBarrelsNorthWall()
    ...
    for i = 0, count - 1 do
      ...
      if BarrelLikelihood() then CreateBarrel("Barrel", 25.0, 0.0, x - 30.0, y - 42.0) end
      if BarrelLikelihood() then CreateBarrel("Barrel", 25.0, 0.0, x - 0.0,  y - 48.0) end
      if BarrelLikelihood() then CreateBarrel("Barrel", 25.0, 0.0, x + 24.0, y - 44.0) end
    end
end
...
function PlaceBarrelsFloor()
    ...
    for i = 0, count do
      ...
      for j = 1, 3 do
        ...
        if BarrelLikelihood() then CreateBarrel("Barrel", 25.0, 0.0, x + atx, y + aty) end
      end
    end
end
...
function PlaceDoors(color)
  for j = 0, 4 - 1 do
    ...
    for i = 0, count - 1 do
      ...
      local door = CreateDoor(color, x, y, j)
...
function PlaceAmaranthRing()
  ...
  for i = 0, count - 1 do
    ...
    CreateItem("Ring", 1, true, x - 100, y - 100)
  end
end
...
function PlaceGeneratorGhosts()
  ...
  for i = 0, count - 1 do
    ...
    CreateGeneratorGhost("GeneratorGhost", 1000.0, 0.0, x + 72.0, y + 32.0)
    CreateGeneratorGhost("GeneratorGhost", 1000.0, 0.0, x + 72.0, y - 48.0)
  ...
  for i = 0, count - 1 do
    ...
    CreateGeneratorGhost("GeneratorGhost", 1000.0, 0.0, x - 0.0, y + 32.0)
    CreateGeneratorGhost("GeneratorGhost", 1000.0, 0.0, x - 0.0, y - 48.0)
    CreateGeneratorGhost("GeneratorGhost", 1000.0, 0.0, x + 128.0, y - 48.0)
    CreateGeneratorGhost("GeneratorGhost", 1000.0, 0.0, x + 128.0, y + 32.0)
...
function PlaceGuides()
  ...
  for i = 0, count - 1 do
    ...
    CreateGuide("Guide", 10000000.0, 0.0, x - 128.0, y - 128.0)
  end
end
...
function PlaceSavePoints()
  ...
  for i = 0, count - 1 do
    ...
    CreateSavePoint("SavePoint", 10000000.0, 0.0, x - 128.0, y - 128.0)
  end
end
...
function PlaceBoss1()
  ...
  for i = 0, count - 1 do
    ...
    CreateQuinotaur1("Quinotaur1", 2500, 4.0, x - 128.0, y - 128.0, 0.0)
  end
end
...
function PlaceBoss2()
  ...
  for i = 0, count - 1 do
    ...
    CreateArachnarex("Arachnarex", 2500, 4.0, x - 128.0, y - 128.0, 0.0)
  end
end
