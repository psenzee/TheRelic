...
function KillCircle1000Spell()
  local c = GetPlayer()
  HitCircleInRadius(c, 512.0, 50.0, 1000.0)
  Call_Multiplayer(c, "SetAreaAttackEffect2")
end

function KillCircle100Spell()
  local c = GetPlayer()
  HitCircleInRadius(c, 512.0, 50.0, 100.0)
...
--Potion0   = { "a",  "Red Potion",              "s", "Potion0",   "\nx",                         "",                          nil,                 false, nil, nil, nil },
--Potion1   = { "a",  "Mana Restore",            "",  "Potion1",   "\nmana x",                    "\nmana",                    nil,                 false, nil, nil, nil },
--Potion1   = { "a",  "Blue Potion",             "s", "Potion1",   "\nx",                         "",                          nil,                 false, nil, nil, nil },
--Potion2   = { "a",  "Greater Heal",            "",  "Potion2",   "\nheal+ x",                   "\nheal+",                   nil,                 false, nil, nil, nil },
...
--Potion5   = { "an", "Orange Potion",           "s", "Potion5",   "\nx",                         "",                          KillCircle100Spell,  true,  nil, nil, nil },
  Potion6   = { "a",  "Teal Potion",             "s", "Potion6",   "\nx",                         "",                          KillCircle100Spell,  true,  nil, nil, nil },
  Potion7   = { "a",  "White Potion",            "s", "Potion7",   "\nx",                         "",                          KillCircle100Spell,  true,  nil, nil, nil },
