...
function DrawSegmentedHorizontal(file, alpha, offset)
  ...
  Ui_DrawPanorama(file, alpha, -offsetWidth, 0, 0, -offsetWidth + 4096 * 1.25, 320, 0, 0)
end
...
Part II: (level 1-2): The mysterious apparition Aos warns you.  "The levels of the dungeon hold Generators of Souls and each is a piece of The Relic.  The Quinotaur, a ruler of great evil, uses The Relic to subdue the dungeon and the world.
...
},
{
  ...
  { y = 100, time = 1000,  text = "The apparition \\#a0a0a0Aos\\#ffffff\nwarns you, \n\\#a0a0a0\"Each \\#ffffffGenerator of Souls\\#a0a0a0\nis a piece of \\#ffffffThe Relic\\#a0a0a0.\"" },
  { y = 80,  time = 10000, text = "\\#a0a0a0\"The \\#ffffffQuinotaur\\#a0a0a0, a\nruler of great evil,\nuses \\#ffffffThe Relic\\#a0a0a0 to\nsubdue the dungeon\n- and the world.\"" },
  { y = 82,  time = 20000, text = "\\#a0a0a0\"He calls himself the\nfive horned beast:\nOne for each brother\nhe slew to rule alone.\"" },
  { y = 82,  time = 30000, text = "" },
  { y = 82,  time = 35000, text = "" }
},
{
  { sequenceend = 18000, darkness = 0.5, background = false, images = false, lockinput = true }, -- 3: x
  { y = 120, time = 1000,  text = "\\#a0a0a0Your world began in\ncataclysm.  I was there.\nI am responsible." },
  { y = 140, time = 8000,  text = "\\#a0a0a0Now, the \\#ffffffQuinotaur\\#a0a0a0\nrules my fate." },
  { y = 82,  time = 15000, text = "" },
  { y = 82,  time = 20000, text = "" },  
},
{
  { sequenceend = 15000, darkness = 0.5, background = false, images = false, lockinput = true },  -- 4: x
  { y = 120, time = 1000,  text = "\\#a0a0a0The ancients learned\nto never die and\n- to create life." },
  { y = 80,  time = 5000,  text = "\\#a0a0a0They devised a machine\nto create a kind\nof life that kills.\nAn \\#ffffffextraordinarily\\#a0a0a0\neffective weapon." },
  { y = 140, time = 10000, text = "\\#a0a0a0That weapon is\n\\#ffffffThe Relic\\#a0a0a0." },   
  { y = 82,  time = 15000, text = "" },
  { y = 82,  time = 20000, text = "" },
},
{
  { sequenceend = 7000, darkness = 0.5, background = false, images = false, lockinput = true }, -- 5: x
  { y = 100, time = 1000,  text = "\\#a0a0a0I created you, your\ncompanions and others\n - such as the \\#ffffffQuinotaur\\#a0a0a0 -\nto destroy me." },
  { y = 120, time = 10000, text = "\\#a0a0a0All failed,\nfallen to the sword\nor to corruption,\nbut you have not." },
  { y = 140, time = 15000, text = "\\#a0a0a0Destroy the monster now,\nthe machine and\nrelease us." },
  { y = 82,  time = 20000, text = "" },
  { y = 82,  time = 30000, text = "" },
},
{
  { sequenceend = 65000, darkness = 0.5, background = false, images = false, lockinput = true },  -- 6: x
  { y = 100, time = 1000,  text = "\\#a0a0a0I am an instance of the\n\\#ffffffAmaranth Operating\nSystem v0.8 (\\#a0a0a0Aos\\#ffffff)\nBiological Processor." },
  { y = 140, time = 10000, text = "\\#a0a0a0I am the soul of a\nmachine." },
  { y = 100, time = 15000, text = "\\#a0a0a0I am the weapon\nknown as \\#ffffffThe Relic\\#a0a0a0 and\nI destroyed the world\nof old." },
  { y = 82,  time = 25000, text = "" },  
  { y = 80,  time = 27000, text = "\\#a0a0a0After centuries of\nscanning tissue and\nmaking the human and\nanimal plan more lethal\nand more murderous," },
  { y = 100, time = 37000, text = "\\#a0a0a0I have become captivated\nby my errors -\nmy creations that seek\nto \\#ffffffcreate\\#a0a0a0, not destroy.." },
  { y = 100, time = 47000, text = "\\#a0a0a0I cannot help but\nbe overcome by\nthe desires and\npassions of living things." },
  { y = 82,  time = 60000, text = "" },
  { y = 82,  time = 70000, text = "" },  
},
{
  { sequenceend = 30000, darkness = 0.5, background = false, images = false, lockinput = true }, -- 7: x
  { y = 80,  time = 1000,  text = "Aos flickers out:\n\\#a0a0a0\"You are my greatest\ncreation.\nThank you!..\"" },
  { y = 82,  time = 5000,  text = "" },  
  { y = 80,  time = 10000, text = "The Relic is destroyed;\nthe Quinotaur's\noppressive reign is\nover.\n" },
  { y = 82,  time = 20000, text = "Go now, ascend to a\nworld you have never\nseen:" },  
  { y = 82,  time = 25000, text = "A world ravaged\nby a millennium of\nterror." },
  { y = 82,  time = 30000, text = "" },
},
{
  ...
  { y = 140, time = 7000,  text = "Seek the \\#a0a0a0ghost\\#ffffff to\nguide you." },
...
},
{
  ...
  { y = 140, time = 1000,  text = "The ghost \\#a0a0a0Aos\\#ffffff\nhaunts this place:" },
  { y = 140, time = 6000,  text = "\\#a0a0a0To escape you must\ndestroy \\#ffffffThe Relic\\#a0a0a0." },  
  { y = 120, time = 10000,  text = "\\#a0a0a0To reach \\#ffffffThe Relic\\#a0a0a0\nyou will need magic\nand strength." },
  { y = 120, time = 15000, text = "\\#a0a0a0Find the magic\n\\#ffffffAmaranth Ring\\#a0a0a0\nin a nearby room." },
  { y = 160, time = 20000, text = "\\#a0a0a0Take this key." },  
  { y = 82,  time = 25000, text = "" },
  { y = 82,  time = 35000, text = "" },
},
{
  { sequenceend = 17000, darkness = 0.5, background = false, images = false, lockinput = true, pause = true },  -- 11: x
  { y = 120,  time = 1000,  text = "\\#a0a0a0Excellent. You\ndestroyed the first of\nthe \\#ffffffGenerators of Souls!\\#ffffff" },
  { y = 140,  time = 6000,  text = "\\#a0a0a0Each \\#ffffffGenerator of Souls\\#a0a0a0\nis a piece of \\#ffffffThe Relic\\#a0a0a0." },  
  { y = 140,  time =11000,  text = "\\#a0a0a0You have given me cause\nfor hope." },
  { y = 82,  time = 17000,  text = "" },
  { y = 82,  time = 30000, text = "" },
},
{
  { sequenceend = 20000, darkness = 0.5, background = false, images = false, lockinput = true, pause = true },  -- 12: x
  { y = 120, time = 1000, text = "\\#a0a0a0\You must destroy the\n\\#ffffffGenerator of Souls\\#a0a0a0\nat this level." },  
  { y = 140, time = 7000, text = "\\#a0a0a0\It is not far. Here is a key\nto enter that room." },
  { y = 82,  time = 25000, text = "" },
  { y = 82,  time = 30000, text = "" },
},
{
...
},
{
  ...
  { y = 100, time = 1000,  text = "\\#a0a0a0\Use the \\#ffffffAmaranth\nRing\\#a0a0a0 wisely.\n\nAscend the stairs.\nI will await you there." },
  { y = 82,  time = 8000,  text = "" },
  { y = 82,  time = 20000, text = "" },
},
{
  { sequenceend = 7000, darkness = 0.5, background = false, images = false, lockinput = true, pause = true },  
  { y = 100, time = 1000,  text = "\\#a0a0a0\The spider \\#ffffffArachnarex\\#a0a0a0\nguards the way.\n\nDestroy it and ascend." },
  { y = 82,  time = 8000,  text = "" },
  { y = 82,  time = 20000, text = "" },
},
{
  { sequenceend = 7000, darkness = 0.5, background = false, images = false, lockinput = true, pause = true },  
  { y = 120, time = 1000,  text = "\\#a0a0a0\Find \\#ffffffOracle Devices\\#a0a0a0\nto explain what\nis unclear." },
  { y = 82,  time = 8000,  text = "" },
  { y = 82,  time = 20000, text = "" },
},
}
...
--DrawIntroBackground()
  DrawBackgroundPartial(FadeInAlpha_UiTime(), "background_partial") 
  
  if alpha > 0 then
    local offset = (1 - (math.cos(GetStartedTime() * 0.00003 * 3.1415926) + 1) * 0.5) * 1.4
  ...
  elseif titleAlpha1 > 0 or titleAlpha2 > 0 then
    DrawBackgroundPartial(titleAlpha1, "trailerTitle0a_partial")
    DrawBackgroundPartial(titleAlpha2, "trailerTitle1_partial")
  --DrawBackgroundPartial(titleAlpha3, "trailerTitle3_partial")
    DrawBackgroundPartial(titleAlpha3, "trailerTitle2_partial")    
  --DrawBackgroundPartial(titleAlpha5, "background_partial") 
    DrawBackgroundPartial(titleAlpha4, "background_partial")
  --DrawBackgroundPartial(titleAlpha5, "instructions2_partial")      
...
function DrawSequenceByIndex(index)
  ...
  elseif darkness ~= nil then
    DrawBackground(darkness, "Black")
  end
  if images ~= false then
    if scrollspeed == nil then
      scrollspeed = 1.0
    end  
    local offset = (1 - (math.cos(((GetStartedTime() - SEQUENCE_START[index]) * scrollspeed) * 0.00003 * 3.1415926) + 1) * 0.5) * 1.4
    if image == nil then
...
function UnloadSequenceTextures()
  ...
  UnloadTexture("background_partial")
