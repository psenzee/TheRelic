...
@interface The_Relic2AppDelegate : NSObject <UIApplicationDelegate, UIAccelerometerDelegate, GKPeerPickerControllerDelegate, GKSessionDelegate, UIAlertViewDelegate, MFMailComposeViewControllerDelegate>
{
    UIWindow *window;
    EAGLView *glView;
