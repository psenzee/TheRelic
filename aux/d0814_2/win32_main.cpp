                   ...
                   LPSTR lpCmdLine, int iCmdShow)
{
    ...
    hWnd = CreateWindow( 
        ...
        0, 0, frameSize.width + frameEdges.width, frameSize.height + frameEdges.height,
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_MOUSEMOVE:
        SetScreenTouchUpdate(LOWORD(lParam), HIWORD(lParam));
        return 0;
    ...
    case WM_LBUTTONUP:
        ...
        SetScreenTouchEnd(LOWORD(lParam), HIWORD(lParam));
        return 0;
