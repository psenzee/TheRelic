...
public:
    ...
    KillableBehavior() : AbstractBehavior(TYPE), mHitPoints(1.f), mMaxHitPoints(1.f), mKiller(0), mHitFrames(0), mLevel(1), mExperience(10), mKnockSpin(1.f), mKnockBackMultiplier(1.f) {}
