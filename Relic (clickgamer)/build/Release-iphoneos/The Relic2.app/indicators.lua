...
function CreateIndicator(name)
  ...
  elseif name == "HealPotionIndicator" then instance = Ui_CreateRenderableButtonJustified(name, "Empty",       "", 2, 512, 190, 512, 190, 1.0, 8.0 * HUD_SCALE * HUD_BUTTON_TEXT_SCALE, 1.0 * HUD_SCALE * HUD_BUTTON_SCALE, 3.6 * HUD_BUTTON_ZSCALE)
...
-- instance = Ui_CreateButton(name, "border88_dark", "+Portal Near Generator", 20, 205, 220, 225, 1.0, 18.75)
  ...
  elseif name == "ShieldButton"        then
    local offset = 7
--  instance = Ui_CreateImageButton(name, "shield_opaq", "", 436, 265, 478, 305, 1.0, 18.75, 0, 1, 1, 0, 0)
    instance = Ui_CreateImageButton(name, "shield1", "", 436 + offset, 265 + iPadOffset, 478 + offset, 305 + iPadOffset, 1.0, 18.75, 0, 1, 1, 0, 0)
