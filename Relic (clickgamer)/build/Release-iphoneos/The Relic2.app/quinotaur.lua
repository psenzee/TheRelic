...
if value.s_seed == nil then value.s_seed = MakeRandomSeed() end
  local c = CreateQuinotaur1(value.s_type, value.s_hp, value.s_speed, value.s_x, value.s_y, value.s_seed)
--c:SetId(value.s_id)  
...
if value.s_seed == nil then value.s_seed = MakeRandomSeed() end
  local c = CreateQuinotaur2(value.s_type, value.s_hp, value.s_speed, value.s_x, value.s_y, value.s_seed)
--c:SetId(value.s_id)  
  c:SetPosition(value.s_x, value.s_y, 0)
  c:ForceOrientation(value.s_orientation)
end
...
function Quinotaur1Killed(c)
  ...
  CreateQuinotaur2("Quinotaur2", 10000, 4.0, x, y, c:GetSeed())
  DestroyCharacter(c)
  StartSequence(WE_ARE_BROTHERS_SEQUENCE)
end
...
function CreateQuinotaur1_Character(c, type, hp, speed, x, y, seed)
   ...
   c:SetWeight(5.0)   
   c:SetApproachTooFar(600 * Random_NextReal(seed) + 100)
...
function CreateQuinotaur1(type, hp, speed, x, y, seed)
   local c = NewCharacter(-1, "Quinotaur1", "Quinotaur1", x, y, 0.0)
   CreateQuinotaur1_Character(c, "Quinotaur1", hp, speed, x, y, seed)
   return c
end
...
function CreateQuinotaur2_Character(c, type, hp, speed, x, y, seed)
...
function CreateQuinotaur2(type, hp, speed, x, y, seed)
   local c = NewCharacter(-1, "Quinotaur2", "Quinotaur2", x, y, 0.0)
   CreateQuinotaur2_Character(c, "Quinotaur2", hp, speed, x, y, seed)
   return c
end
