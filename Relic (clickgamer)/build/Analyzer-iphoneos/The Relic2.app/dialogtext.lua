...
DIALOG_TEXT = 
{
  ...
  L1_A_WhereAmI          = "\nThese are the depths of an ancient\ndungeon called \\#8080ffPandora's Mouth\\#ffffff.\t\nEscape is\tunlikely.\tYou were sent\nhere to die.",
  L1_A_WhoSentMeHere     = "\nWell,\tthe \\#8080ffQuinotaur\\#ffffff, of course.",
  L1_A_TheQuinotaur      = "\nA man possibly and certainly a\nbeast.\t He rules the living, the dead,\t\nand we who are neither.\t\tHe uses\n\\#8080ffThe Relic\\#ffffff to turn the dead against\nthe quick.",
  L1_A_AosIntro          = "\nI am \\#8080ffAos\\#ffffff,\ta watcher.\n\nI will be watching you\tfrom every\ncorner of this pit.",
  L1_A_TheRelic          = "\nIt is \\#8080ffThe Relic\\#ffffff that makes this hole\na hell.",
  L1_A_DestroyGenerator  = "\nTo leave, you must destroy the\n\\#8080ffGenerators of Souls\\#ffffff.\t\n\nThere is one at this depth not far\nfrom here.",
  L1_A_TheGenerator      = "\nThe \\#8080ffGenerators of Souls\\#ffffff could\nbe considered pieces of \\#8080ffThe Relic\\#ffffff.\n",
  L1_A_HowToDestroyIt    = "\nTo reach and destroy the\ngenerator you must use magic as\nwell as your significant physical\nstrength.",
  L1_A_HowMagic          = "\nSeek the \\#8080ffAmaranth Ring\\#ffffff, hidden in\na room nearby. \tIt will enable you\nto perform great feats of sorcery.\t\t\n\nWill you retrieve this ring?",
  L1_A_TellMeAbout       = "\nWhat do you wish to know about?\n\nPotions, Spells, Keys or Gold?",
  L1_A_AboutPotions      = "\nPotions:$TODO",
  L1_A_AboutPortals      = "\n.. with thoughtful use, the \\#8080ffPortal Spell\\#ffffff\ncan make your quests much easier.",  
  L1_A_AboutSpells       = "\nSpells:$TODO",
  L1_A_AboutKeys         = "\nKeys:$TODO",
  L1_A_AboutGold         = "\nGold:$TODO",
