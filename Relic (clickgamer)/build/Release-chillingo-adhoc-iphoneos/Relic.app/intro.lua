...
function DrawSegmentedHorizontal(file, alpha, offset)
  ...
  Ui_DrawPanorama(file, alpha, -offsetWidth, offsetHeight, 0, -offsetWidth + 4096 * 1.25 * overallScale, 320 * overallScale + offsetHeight, 0, 0)
end

function DrawCanvas(alpha)
  if not IsHiResDevice() then return; end
  local offset = SEGMENTED_HORIZONTAL_OFFSET
  for i = 0, 8192, 512 do 
...
},
{
  ...
  { y = 100, time = 1000,  text = "The apparition \\#80ff80Aos\\#ffffff\nwarns you, \n\\#80ff80\"Each \\#ffffffGenerator of Souls\\#80ff80\nis a piece of \\#ffffffThe Relic\\#80ff80.\"" },
  { y = 80,  time = 10000, text = "\\#80ff80\"The \\#ffffffQuinotaur\\#80ff80, a\nruler of great evil,\nuses \\#ffffffThe Relic\\#80ff80 to\nsubdue the dungeon\n- and the world.\"" },
  { y = 82,  time = 20000, text = "\\#80ff80\"He calls himself the\nfive horned beast:\nOne for each brother\nhe slew to rule alone.\"" },
  { y = 82,  time = 30000, text = "" },
...
},
{
  ...
  { y = 160, time = 1000,  text = "The ghost speaks:" },  
  { y = 120, time = 6000,  text = "\\#80ff80The ancients learned\nto never die and\n- to create life." },
  { y = 80,  time = 14000, text = "\\#80ff80They devised a machine\nto create a kind\nof life that kills.\nA \\#fffffftragically\\#80ff80\neffective weapon." },
  { y = 140, time = 20000, text = "\\#80ff80That weapon is\n\\#ffffffThe Relic\\#80ff80." },
  { y = 140, time = 27000, text = "\\#80ff80It destroyed\nthe world of old." },  
  { y = 82,  time = 30000, text = "" },
  { y = 140, time = 32000, text = "\\#80ff80Now, the \\#ffffffQuinotaur\\#80ff80\nrules \\#ffffffThe Relic" },  
  { y = 160, time = 40000, text = "\\#80ff80And our fates." },
  { y = 82,  time = 45000, text = "" },
},
{
  { sequenceend = 30000, darkness = 0.5, background = false, images = false, lockinput = true }, -- 5: x
  { y = 100, time = 1000,  text = "\\#80ff80I created the\n\\#ffffffQuinotaur\\#80ff80\nand his brothers -\nto destroy me." },
  { y = 80, time = 10000, text = "\\#80ff80All failed,\nfallen to the sword\nor to corruption.\n\nYet you have not." },
  { y = 100, time = 20000, text = "\\#80ff80Destroy the monster\nnow,\nthe machine and\nrelease us." },
  { y = 82,  time = 30000, text = "" },
...
},
{
  ...
  { y = 100, time = 5000,  text = "\\#80ff80I am an instance of the\n\\#ffffffAmaranth Operating\nSystem v0.8 (\\#80ff80Aos\\#ffffff)\nBiological Processor." },
  { y = 140, time = 11000, text = "\\#80ff80I am the soul of a\nmachine." },
  { y = 80, time = 15000, text = "\\#80ff80The soul of the weapon\nknown as \\#ffffffThe Relic\\#80ff80.\n\nI destroyed the world\nof old." },
  { y = 82,  time = 25000, text = "" },  
  { y = 100, time = 27000, text = "\\#80ff80After centuries of\nscanning tissue and\nmaking the human plan\nmore lethal," },
  { y = 100, time = 37000, text = "\\#80ff80I have become captivated\nby my errors -\nmy creations that seek\nto \\#ffffffcreate\\#80ff80, not destroy.." },
  { y = 100, time = 47000, text = "\\#80ff80I cannot help but\nbe overcome by the\ndesires and passions\nof living things." },
...
},
{
  ...
  { y = 100, time = 1000,  text = "Aos flickers out:\n\\#80ff80You are my greatest\ncreation.\n\nThank you." },
  { y = 82,  time = 5000,  text = "" },  
  { y = 80,  time = 10000, text = "The \\#80ff80Relic\\#ffffff is destroyed.\n\nThe Quinotaur's\noppressive reign is\nover.\n" },
...
},
{
  ...
  { y = 140, time = 7000,  text = "Seek the \\#80ff80ghost\\#ffffff to\nguide you." },
...
},
{
  ...
  { y = 140, time = 1000,  text = "The ghost \\#80ff80Aos\\#ffffff\nhaunts this place:" },
  { y = 140, time = 6000,  text = "\\#80ff80To escape you must\ndestroy \\#ffffffThe Relic\\#80ff80." },  
  { y = 120, time = 10000,  text = "\\#80ff80To reach \\#ffffffThe Relic\\#80ff80\nyou will need magic\nand strength." },
  { y = 120, time = 15000, text = "\\#80ff80Find the magic\n\\#ffffffAmaranth Ring\\#80ff80\nin a nearby room." },
  { y = 160, time = 20000, text = "\\#80ff80Take this key." },  
  { y = 82,  time = 25000, text = "" },
  { y = 82,  time = 35000, text = "" },
},
{
  { sequenceend = 17000, darkness = 0.5, background = false, images = false, lockinput = true, pause = true },  -- 11: x
  { y = 120,  time = 1000,  text = "\\#80ff80Excellent. You\ndestroyed the first of\nthe \\#ffffffGenerators of Souls!\\#ffffff" },
  { y = 140,  time = 6000,  text = "\\#80ff80Each \\#ffffffGenerator of Souls\\#80ff80\nis a piece of \\#ffffffThe Relic\\#80ff80." },  
  { y = 140,  time =11000,  text = "\\#80ff80You have given me cause\nfor hope." },
  { y = 82,  time = 17000,  text = "" },
  { y = 82,  time = 30000, text = "" },
},
{
  { sequenceend = 20000, darkness = 0.5, background = false, images = false, lockinput = true, pause = true },  -- 12: x
  { y = 120, time = 1000, text = "\\#80ff80\You must destroy the\n\\#ffffffGenerator of Souls\\#80ff80\nat this level." },  
  { y = 140, time = 7000, text = "\\#80ff80\It is not far. Here is a key\nto enter that room." },
  { y = 82,  time = 25000, text = "" },
  { y = 82,  time = 30000, text = "" },
},
{
...
},
{
  ...
  { y = 100, time = 1000,  text = "\\#80ff80\Use the \\#ffffffAmaranth\nRing\\#80ff80 wisely.\n\nAscend the stairs.\nI will await you there." },
  { y = 82,  time = 8000,  text = "" },
  { y = 82,  time = 20000, text = "" },
},
{
  { sequenceend = 7000, darkness = 0.5, background = false, images = false, lockinput = true, pause = true },  
  { y = 100, time = 1000,  text = "\\#80ff80\The spider \\#ffffffArachnarex\\#80ff80\nguards the way.\n\nDestroy it and ascend." },
  { y = 82,  time = 8000,  text = "" },
  { y = 82,  time = 20000, text = "" },
},
{
  { sequenceend = 7000, darkness = 0.5, background = false, images = false, lockinput = true, pause = true },  
  { y = 120, time = 1000,  text = "\\#80ff80\Find \\#ffffffOracle Devices\\#80ff80\nto explain what\nis unclear." },
  { y = 82,  time = 8000,  text = "" },
  { y = 82,  time = 20000, text = "" },
},
{
...
--DrawIntroBackground()
  DrawBackgroundPartial(FadeInAlpha_UiTime(), ChooseImage("background_partial", "background_partial_x2"))
  ...
  elseif titleAlpha1 > 0 or titleAlpha2 > 0 then
    DrawBackgroundPartial(titleAlpha1, ChooseImage("trailerTitle0a_partial", "trailerTitle0a_partial_X2"))
    DrawBackgroundPartial(titleAlpha2, ChooseImage("trailerTitle2_partial", "trailerTitle2_partial_x2")) 
    DrawBackgroundPartial(titleAlpha3, ChooseImage("trailerTitle2_partial", "trailerTitle2_partial_x2"))
    DrawBackgroundPartial(titleAlpha4, ChooseImage("trailerTitle2_partial", "trailerTitle2_partial_x2"))
...
function UnloadSequenceTextures()
  ...
  UnloadTexture(ChooseImage("background_partial", "background_partial_x2"))  
