...
public:
    ...
    Attack() : AbstractBehavior(TYPE),
               mAttackSpeed(1.f), mMaxAttackDistance(60.f), mAttackMultiplier(1.f), mAttackTarget(0),
    ...
    inline void             SetAttackMultiplier(float m)      { mAttackMultiplier = m < 1.f ? 1.f : m; }
    ...
    inline float            GetAttackMultiplier() const       { return mAttackMultiplier; }
