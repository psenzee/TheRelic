...
// support code
static void CreateCloud(const char *filename, const Vector3 &position, float time, float speed)
{ 
...
{
    return CreateCloud("dust_glow_shadow_desat", Vector3(at.x, at.y, -100.f), 500.f, 3.f);
}
...
{
    return CreateCloud("blue_glow_shadow", Vector3(at.x, at.y, -145.f), 500.f, 4.f);
}
