...
- (void)easyTableView:(EasyTableView *)easyTableView scrolledToOffsetComplete:(CGPoint)contentOffset;
- (void)easyTableView:(EasyTableView *)easyTableView selectedView:(UIView *)selectedView atIndex:(NSUInteger)index deselectedView:(UIView *)deselectedView deselectedIndex:(NSUInteger)deselIndex;
...
@property                       UITableViewCellSeparatorStyle cellSeparatorStyle;
...
@property (nonatomic)           BOOL reuseCells;
