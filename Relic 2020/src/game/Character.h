...
public:
    ...
    void              SetAlpha(float alpha) { mAlpha = alpha; mAnimation->SetAlpha(mAlpha); }
    ...
    Character        *GetClosestFacingAndAttackable(float radius);
	...
	void              SetUpdateFrequency(int freq)  { mUpdateFrequency = freq; }
