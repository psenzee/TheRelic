#ifndef _TCPSOCKETADDRESS_H
#define _TCPSOCKETADDRESS_H

#include "IAddress.h"
#include "Sockets.h"
#include "Address.h"

class TcpSocketAddress : public IAddress
{
public:

    TcpSocketAddress(IAddress::Domain domain, IAddress::Protocol protocol, 
