...
public:
    ...
    inline void Set(bool value) { GLSetEnabled(mState, value); }
private:
    int mState;
};
...
{
public:    
    inline void Set(bool value) { GLSetDepthWrite(value); }
private:
};
...
public:
    ...
    inline void Set(bool value) { GLSetEnabledClientState(mState, value); }
private:
    int mState;
};
...
public:
    ...
    inline void Set(float value) { GLSetLight(mId, mState, value); }
private:
    int mId, mState;
};
...
public:
    ...
    inline void Set(const T &value) { GLSetLight4(mId, mState, static_cast<const float *>(&value)); }
private:
    int mId, mState;
};
...
public:
    ...
    inline void Set(float value) { GLSetMaterial(mState, value); }
private:
    int mState;
};
...
public:
    ...
    inline void Set(const T &value) { GLSetMaterial4(mState, static_cast<const float *>(&value)); }
private:
    int mState;
};
