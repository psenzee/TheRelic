...
public:
    ...
    inline RenderContext(GraphicsDevice &device, const OverheadCamera &camera) : device(device), camera(camera), color(1.f, 1.f, 1.f, 1.f), blur(false), transparent(false), breakFunction(0) {}
};
