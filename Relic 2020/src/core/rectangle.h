...
public:    
    ...
    inline Rectangle(int32_t x, int32_t y, int32_t w, int32_t h) : x(x), y(y), width(w), height(h) {}
    inline Rectangle(int32_t x, int32_t y, const core::Size &sz) : x(x), y(y), width(sz.width), height(sz.height) {}
