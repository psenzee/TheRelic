...
public:
    ...
    int                                 GetCountOfTypeAt(int type, const core::Point &at) const;
    int                                 GetCountOfType(int type, const core::Rectangle &range);
...
private:
    ...
    bool UncollideFromSorted(item_t *item, item_t **list, int count);
    bool Uncollide2(item_t *item, const core::Point &at);
    int  GetSortedList(item_t **items, int maxcount, const core::Point &at, int weightSeed);
