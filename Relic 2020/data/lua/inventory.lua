...
function AddToInventory(c, type, count)
  AddToInventoryMax(c, type, count, nil)
end

function AddOneToInventory(c, type)
  AddToInventoryMax(c, type, 1, nil)
end

function AddToPlayerInventoryMax(type, count, max)
  AddToInventoryMax(GetPlayer(), type, count, max)
end

function AddToPlayerInventory(type, count)
  AddToPlayerInventoryMax(type, count, nil)
end

function AddOneToPlayerInventory(type)
  AddToPlayerInventoryMax(type, 1, nil)
end
