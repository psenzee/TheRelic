...
function EnableContinueSavedGame()
  local saveexist = DoesSavedGameExist("saveprofile1.bin")
...
function DoSaveGameUi()
  ResumeFromInGame()
  DeferByTimeMs(250, "ShowSaveGameDialog", "Would you like to\nsave your game?", "Save Game")
end
]]--
...
function MenuListener(info, data)
  ...
  if info == 'SELECTED' then
    UiSelectSound()  
    if     data.name == 'Resume'         then ResumeFromInGame()
    elseif data.name == 'ExitGame'       then ShowReallyQuitMenu()
    ...
    elseif data.name == 'GoToMap'        then HideMenusRestoreHud(); ToggleMap()
    elseif data.name == 'Back'        then HideMenusRestoreHud();
    elseif data.name == 'YesSaveGame'    then ResumeFromInGame(); SavePrimaryPlayer()
...
--  elseif data.name == 'MainMenu_StartNewGame' then ShowStartNewMenu()
    ...
    elseif data.name == 'BackToLevelCompleteMenu' then  HideMenusRestoreHud(); ShowLevelCompleteMenu()
    elseif data.name == 'Upgrade_IncreaseMaxHealth' then  HideMenusRestoreHud(); ShowUpgradeMenu_IncreaseMaxHealth()
    elseif data.name == 'Upgrade_IncreaseMaxMana' then  HideMenusRestoreHud(); ShowUpgradeMenu_IncreaseMaxMana()    
    elseif data.name == 'Upgrade_MagicShield' then  HideMenusRestoreHud(); ShowUpgradeMenu_MagicShield()
    elseif data.name == 'Upgrade_MagicBolt' then  HideMenusRestoreHud(); ShowUpgradeMenu_MagicBolt()
    elseif data.name == 'Upgrade_DivineTouch' then  HideMenusRestoreHud(); ShowUpgradeMenu_DivineTouch()
    elseif data.name == 'Upgrade_AtomicTouch' then  HideMenusRestoreHud(); ShowUpgradeMenu_AtomicTouch()
    elseif data.name == 'Upgrade_Immolate' then  HideMenusRestoreHud(); ShowUpgradeMenu_Immolate()
    elseif data.name == 'Purchase_IncreaseMaxHealth' then  HideMenusRestoreHud(); Purchase_IncreaseMaxHealth(); ShowLevelCompleteMenu()
    elseif data.name == 'Purchase_IncreaseMaxMana' then  HideMenusRestoreHud(); Purchase_IncreaseMaxMana(); ShowLevelCompleteMenu()
    elseif data.name == 'Purchase_MagicShield' then  HideMenusRestoreHud(); Purchase_MagicShield(); ShowLevelCompleteMenu()
    elseif data.name == 'Purchase_MagicBolt' then  HideMenusRestoreHud(); Purchase_MagicBolt(); ShowLevelCompleteMenu()
    elseif data.name == 'Purchase_DivineTouch' then  HideMenusRestoreHud(); Purchase_DivineTouch(); ShowLevelCompleteMenu()
    elseif data.name == 'Purchase_AtomicTouch' then  HideMenusRestoreHud(); Purchase_AtomicTouch(); ShowLevelCompleteMenu()
    elseif data.name == 'Purchase_Immolate' then  HideMenusRestoreHud(); Purchase_Immolate(); ShowLevelCompleteMenu()
    ...
    elseif data.name == 'LoadMenu_SinglePlayer'     then EndTitleSequence(); MainMenu_LoadGameSinglePlayer() 
...
--  elseif data.name == 'MainMenu_LoadGame'     then ShowLoadGameMenu() 
    elseif data.name == 'MainMenu_LoadGame'     then EndTitleSequence(); MainMenu_LoadGameSinglePlayer()  
    ...
    elseif data.name == 'MakeRedKey'      then AddToInventory(GetPlayer(), "KeyRed",  1)
    elseif data.name == 'MakeWhiteKey'    then AddToInventory(GetPlayer(), "KeyWhite", 1)
    elseif data.name == 'MakeBlueKey'     then AddToInventory(GetPlayer(), "KeyBlue", 1)
    elseif data.name == 'MakePortalSpell' then AddToInventory(GetPlayer(), "Potion5", 1)
    elseif data.name == 'MakeTurnSpell'   then AddToInventory(GetPlayer(), "Book2", 1)
...
function AddMenuButtonSmall(parent, name, text, width)
...
function CreateMenus()
  BACKGROUND_MENU_IMAGE = Ui_CreateImageButton("Background1", "intro10c_map_256sq", "", 0, 0, 480, 320, 1.0, 18.75, 0, 1, 1, 0, 0)
  BACKGROUND_MAIN_MENU_IMAGE = Ui_CreateImageButton("BackgroundMain", "menuback_partial", "", 0, 0, 480, 320, 1.0, 18.75, 0, 1, 0.9375, 0.375, 0)  
...
function AddRelicTitleTo(menu)
  local x =  145
  local y = -135
  local title = Ui_CreateImageButton("", "RelicLogoInGame", "", 0 + x, 0 + y, 512 + x, 256 + y, 1.0, 25, 0, 1, 1, 0.5, 0)
...
function CreateMainMenu()
  ...
  MAIN_MENU = Ui_CreateMenu("MainMenu", "border3", "..", 240 - halfWidth, MENUS_TOP, 240 + halfWidth, MENUS_TOP, 1.0, 22.5)
...
function CreateExtrasMenu()
  local width = MENUS_WIDTH
  local halfWidth = width * 0.5
  EXTRAS_MENU = Ui_CreateMenu("ExtrasMenu", "border3", "..", 240 - halfWidth, MENUS_TOP, 240 + halfWidth, MENUS_TOP, 1.0, 22.5)
...
function CreateLoadGameMenu()
  local width = MENUS_WIDTH
  local halfWidth = width * 0.5
  NEW_LOAD_GAME_MENU = Ui_CreateMenu("MultiplayerStartNewMenu", "border3", "..", 240 - halfWidth, MENUS_TOP, 240 + halfWidth, MENUS_TOP, 1.0, 22.5)
...
function CreateMultiplayerMenu()
  local width = MENUS_WIDTH
  local halfWidth = width * 0.5
  MULTIPLAYER_MENU = Ui_CreateMenu("MultiplayerMenu", "border3", "..", 240 - halfWidth, MENUS_TOP, 240 + halfWidth, MENUS_TOP, 1.0, 22.5)
...
function CreateStartNewMenu()
  local width = MENUS_WIDTH
  local halfWidth = width * 0.5
  START_NEW_MENU = Ui_CreateMenu("MultiplayerStartNewMenu", "border3", "..", 240 - halfWidth, MENUS_TOP, 240 + halfWidth, MENUS_TOP, 1.0, 22.5)
...
function CreateSaveExitMenu()
  local width = MENUS_WIDTH
  local halfWidth = width * 0.5
  SAVE_EXIT_MENU = Ui_CreateMenu("SaveExitMenu", "border3", "..", 240 - halfWidth, MENUS_TOP - 25, 240 + halfWidth, MENUS_TOP - 25, 1.0, 22.5)
...
function GetUnspentKills()
  ...
  if data.unspentKills == nil then
    data.unspentKills = kills
  end
...
--AddTextLine(LEVEL_COMPLETE_MENU, "", dividerHeight, size)
  ...
  AddTextLine(LEVEL_COMPLETE_MENU, "", dividerHeight, size)
  LEVEL_COMPLETE_MENU_INC_MAX_HEALTH = AddMenuButtonSmall(LEVEL_COMPLETE_MENU, "Upgrade_IncreaseMaxHealth",  "Increase Max Health",  width)
  LEVEL_COMPLETE_MENU_INC_MAX_MANA = AddMenuButtonSmall(LEVEL_COMPLETE_MENU, "Upgrade_IncreaseMaxMana",  "Increase Max Mana",  width)
  LEVEL_COMPLETE_MENU_DIVINE_TOUCH = AddMenuButtonSmall(LEVEL_COMPLETE_MENU, "Upgrade_DivineTouch",  "Divine Touch",  width)  
  LEVEL_COMPLETE_MENU_MAGIC_SHIELD = AddMenuButtonSmall(LEVEL_COMPLETE_MENU, "Upgrade_MagicShield",  "Magic Shield",  width)  
  LEVEL_COMPLETE_MENU_IMMOLATE = AddMenuButtonSmall(LEVEL_COMPLETE_MENU, "Upgrade_Immolate",  "Immolate",  width)  
  LEVEL_COMPLETE_MENU_MAGIC_BOLT = AddMenuButtonSmall(LEVEL_COMPLETE_MENU, "Upgrade_MagicBolt",  "Magic Bolt",  width) 
  LEVEL_COMPLETE_MENU_ATOMIC_TOUCH = AddMenuButtonSmall(LEVEL_COMPLETE_MENU, "Upgrade_AtomicTouch",  "Atomic Touch",  width)     
  AddTextLine(LEVEL_COMPLETE_MENU, "", dividerHeight, size)  
...
function CreateCredits()
  ...
  AddTextLine(CREDITS_SCREEN, "\\#808080A \\#ffffffPaul Senzee \\#808080Game", height, size)
  ...
  AddTextLine(CREDITS_SCREEN, "", dividerHeight, size)
  AddTextLine(CREDITS_SCREEN, "\\#808080design, programming & environment art", height, size)
  ...
  AddTextLine(CREDITS_SCREEN, "..", height, size)
  AddTextLine(CREDITS_SCREEN, "", dividerHeight, size)  
  ...
  AddTextLine(CREDITS_SCREEN, "", dividerHeight * 20, size)  
...
function AddResumeButton(page)
  local resume = Ui_CreateButton("Resume", "darkborder", "resume", 350, 15, 470, 15 + 40, 1.0, 30.0)   
  UiControl_AddChild(page, resume)
--RegisterUiListener("Resume", "MenuListener", { name = "Resume" })
end

function CreateInGameMapPage()
  MAP_PAGE = Ui_CreateMenu("MapPage", "border3", "..", 0, 0, 480, 320, 1.0, 22.5)
  local title = Ui_CreateText("Map", "Pause", 20, TITLE_START, 80, TITLE_START + 50, 1.0, 30.0, false) 
  AddResumeButton(MAP_PAGE)
--UiControl_AddChild(MAP_PAGE, Ui_CreateButton("LoadGame", "border88_dark", "Load Game", 40, 120, 260, 140, 1.0, 18.75))  
