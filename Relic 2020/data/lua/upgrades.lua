...
UPGRADES = 
{
  ...
  { name="+ Maximum Health",  cost=25,  required="None", order=1,
    ...
    purchase_fn=_Purchase_IncreaseMaxHealth,
    maxed_fn=(function (p, d) return p:GetMaxHitPoints() >= MAX_HEALTH; end) },
  ...
  { name="+ Maximum Mana",    cost=25,  required="Amaranth Ring", order=2,
    ...
    purchase_fn=_Purchase_IncreaseMaxMana,
    maxed_fn=(function (p, d) return d.manaMax >= MAX_MANA; end) },
  ...
  { name="+ Axe Damage",    cost=25,  required="None", order=3,
    ...
    purchase_fn=_Purchase_IncreaseMeleeDamage,
    maxed_fn=(function (p, d) return false; end) },

  MagicBolt =
  { name="Magic Bolt",               cost=25,  required="Amaranth Ring", order=4,
    level_multiplier=0,
    text="Fire a magic projectile that consumes mana.",
    purchase_fn=(function (p, d) d.isBoltEnabled = true; ShowAchievement("MagicBolt"); end),
    maxed_fn=(function (p, d) return d.isBoltEnabled; end) },
  ...
  { name="+ Magic Bolt Damage",    cost=25,  required="Magic Bolt", order=5,
    ...
    purchase_fn=_Purchase_IncreaseMagicBoltDamage,
    maxed_fn=(function (p, d) return false; end) },
  ...
  { name="Divine Touch",             cost=50,  required="Amaranth Ring", order=6,
    ...
    purchase_fn=(function (p, d) d.isDivineTouchEnabled = true; ShowAchievement("DivineTouch"); end),
    maxed_fn=(function (p, d) return d.isDivineTouchEnabled; end) },
    
  MagicShield =
  { name="Magic Shield",             cost=75,  required="Amaranth Ring", order=7,
    level_multiplier=0,
    text="Create a magic shield that consumes mana.",
    purchase_fn=(function (p, d) d.isShieldEnabled = true; ShowAchievement("Shield"); end),
    maxed_fn=(function (p, d) return d.isShieldEnabled; end) },
  ...
  { name="Immolate",                 cost=100,  required="Amaranth Ring", order=8,
    ...
    purchase_fn=(function (p, d) d.isImmolateEnabled = true; ShowAchievement("Immolate"); end),
    maxed_fn=(function (p, d) return d.isImmolateEnabled; end) },
    
  AtomicTouch =
  { name="Cataclysm",             cost=500, required="Amaranth Ring", order=9,
    level_multiplier=0,
...
function GetUpgradeCost(upgrade)
  ...
  if upgrade.level_multiplier > 0 then
    return cost * upgrade.level_multiplier * level
  end
  return cost
end
...
function HandleUpgradeEvent(name)
  ...
  for key, upgrade in pairs(UPGRADES) do
    ...
    elseif name == ('Purchase_' .. key) then
      ...
      data.unspentKills = data.unspentKills - cost
      ShowLevelCompleteMenu()
      return true
    end
  end
...
local function _UpdateLevelCompleteMenu(isStore)
  ...
  for i = startList, endList do    
    ...
    local cost = GetUpgradeCost(upgrade)
    _SetTextForUpgradeOption(upgrade.button, upgrade.name, _SatisfiesUpgradeCriteria(upgrade.key, cost, upgrade.maxed_fn(player, data)))
  end
