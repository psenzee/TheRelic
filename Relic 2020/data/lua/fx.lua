...
function SetAreaAttackEffect2(character)
  ...
  character:AddDiscEffect("FireSelectorOpaqueSat2", 3, 10.0, 8.0 * scale, 100, 20.0 * scale, 0)
  character:AddDiscEffect("FireSelectorOpaqueSat2", -0.2, 20.0, 4.0 * scale, 30, 15.0 * scale, 0)
...
function SetAreaAttackEffect3(character)
  ...
  character:AddDiscEffect("BlueSelectorOpaqueSat2", -0.2, 10.0, 8.0 * scale, 20, 27.0 * scale, 0)
  SetFadeColor(1.0, 1.0, 1.0, 1.0)  
  DoFlash(250)
  Audio_PlayAt("#vibrate", 0, 0, 0, 6.0)  
end
...
function FireProjectileIndependent(x, y)
  return CreatePerpetualCloudLitIndependent("fire2", x, y, -10, 500.0, 3.0)
end
...
function PlayerProjectileIndependent(x, y)
  ...
  return CreatePerpetualCloudLitIndependent("magic_bolt", x, y, -10, 500.0, 3.0)
end
