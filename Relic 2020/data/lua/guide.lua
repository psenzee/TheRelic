...
function GiveGeneratorQuestItems()
  ...
  AddToPlayerInventoryMax("KeyBlue", 1, 1)
end
...
function GuideDialog()
  ...
  elseif level == 4 then
    ...
    elseif LOCAL_GAME_STATE.DestroyedCompleteGenerator then
      ...
      MessageRise("@20\\#808080Forge of Souls\\#ffffff", 0)
      DO_GUIDE_CLOSE = false
    end
  elseif level == 5 then
  ...
  elseif level == 9 then
    ...
    MessageRise("@20the \\#808080Quinotaur\\#ffffff", 0)
    DO_GUIDE_CLOSE = false
  elseif level == 10 then
    StartSequence(QUINOTAUR_SEQUENCE_1)
    DO_GUIDE_CLOSE = true
  elseif level > 10 and level < 12 then
    MessageRise("@20\\#ffffffFind \\#808080The Relic\\#ffffff", 0)
    DO_GUIDE_CLOSE = false
  elseif level == 12 then
    MessageRise("@20\\#ffffffDestroy \\#808080The Relic\\#ffffff", 0)
    DO_GUIDE_CLOSE = false
  end
end
