...
void   print_triangle(triangle *t, int PPHIGSflag);
void   pphigs_header(int level);
void   pphigs_trailer();
point *normalize(point *p);
point *midpoint(point *a, point *b);
void   print_object(object *obj, int level, int PPHIGSflag);
...
int sphere_main(int ac, const char **av)
{
    object *obj = NULL;
    ...
    object *sphere = create_sphere(ccwflag, maxlevel);

    /* Print out resulting approximation */
    print_object(sphere, maxlevel, PPHIGSflag);
...
void print_object(object *obj, int level, int PPHIGSflag)
{
    ...
    for (i = 0; i < obj->npoly; i++)
	    print_triangle(&obj->poly[i], PPHIGSflag);
...
void pphigs_header(int level)
{
    ...
    switch (level)
    {
	case 1:	    dx = -2000; dy =  2000; dz = 0; break;
	case 2:	    dx =  2000; dy =  2000; dz = 0;	break;
	case 3:	    dx = -2000; dy = -2000; dz = 0;	break;
	case 4:	    dx =  2000; dy = -2000; dz = 0;	break;
	case 5:	    dx =     0; dy =	 0; dz = 0;	break;
