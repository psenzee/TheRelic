...
/*
inline std::vector<Tuple3f> &Matrix4f::points(std::vector<Tuple3f> &v) const
{
...
/*
inline void Matrix4f::scale(const vec3_t &s, const vec3_t &origin)
{
...
{
    float h = cosf(fov * 0.5f) / sin(fov * 0.5f);
