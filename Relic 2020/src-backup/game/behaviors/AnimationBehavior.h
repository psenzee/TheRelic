...
public:
    ...
    void        SetAttackTypeCount(int count) { mAttackTypeCount = count; }
    ...
    inline void SetWalkAndAttack(bool value)  { mWalkAndAttack = value; }
    inline bool GetWalkAndAttack() const      { return mWalkAndAttack; }
